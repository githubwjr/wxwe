        ...
        <table class="table table-hover  table-responsive">
            ...
            <tbody id='tbody-items'>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(cv('universalform.category.edit')) { ?>
                    ...
                    <td>
                          <?php if(cv('universalform.category.edit')) { ?><a data-toggle="ajaxRemove" href="<?php  echo webUrl('universalform/category/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm" data-confirm="确认删除此分类?"><i class="fa fa-trash"></i> 删除</a><?php  } ?>
                    </td>
                    </td>
                </tr>
                <?php  } } ?> 
