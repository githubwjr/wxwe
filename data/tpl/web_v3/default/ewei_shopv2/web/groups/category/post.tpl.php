...
<div class="page-header">
    当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>商品分类 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['name'];?>】<?php  } ?></small></span>
</div>
<div class="page-content">
    ...
    <form  <?php if( ce('groups.category' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <label class="col-lg control-label">分类连接(点击复制)</label>
        ...
        <div class="form-group" style="display: none;">
            <label class="col-lg control-label">是否拼团首页推荐</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">是否拼团首页显示</label>
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('groups.category' ,$item) ) { ?>
                <label class='radio-inline'>
