    ...
    <table class='table table-responsive' style='table-layout: fixed;'>
        ...
        <tr class='trbody' style="border-bottom: 1px solid #efefef">
            ...
            <td style='text-align:right;border-left:none;'>
                yen <?php  if($item['is_team']==1) { ?><?php  echo $item['groupsprice'];?><?php  } else { ?><?php  echo $item['singleprice'];?><?php  } ?>
                <br/>x1
            </td>
            ...
            <td style='text-align:center' >
                yen <?php  echo number_format($item['price']-$item['creditmoney']+$item['freight'],2)?>
                ...
                <tr>
                    ...
                    <td  style='border:none;text-align:right;;'>
                        yen <?php  echo number_format($item['price'] + $item['discount'],2)?>
                    </td>
                </tr>
                <tr>
                    <td  style='border:none;text-align:right;'>运费：</td>
                    <td  style='border:none;text-align:right;;'>yen <?php  echo number_format( $item['freight'],2)?></td>
                </tr>
                <?php  if($item['discount']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>团长优惠：</td>
                    <td class='text-danger' style='border:none;text-align:right;'>- yen<?php  echo $item['discount'];?></td>
                </tr>
                <?php  } ?>
                <?php  if($item['discountprice']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>会员折扣：</td>
                    <td  class='text-danger' style='border:none;text-align:right;;'>-yen <?php  echo number_format( $item['discountprice'],2)?></td>
                </tr>
                <?php  } ?>
                <?php  if($item['creditmoney']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>积分抵扣：</td>
                    <td  class='text-danger' style='border:none;text-align:right;;'>-yen <?php  echo number_format( $item['creditmoney'],2)?></td>
                </tr>
                <?php  } ?>
                <?php  if($item['deductenough']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>满额立减：</td>
                    <td  class='text-danger' style='border:none;text-align:right;;'>-yen <?php  echo number_format( $item['deductenough'],2)?></td>
                </tr>
                <?php  } ?>
                <?php  if($item['couponprice']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>优惠券优惠：</td>
                    <td  class='text-danger' style='border:none;text-align:right;;'>-yen <?php  echo number_format( $item['couponprice'],2)?></td>
                </tr>
                <?php  if($item['isdiscountprice']>0) { ?>
                <tr>
                    <td  style='border:none;text-align:right;'>促销优惠：</td>
                    <td  class='text-danger' style='border:none;text-align:right;;'>-yen <?php  echo number_format( $item['isdiscountprice'],2)?></td>
                </tr>
                <?php  } ?>
                <?php  } ?>
                ...
                <tr>
                    ...
                    <?php  if(0<$item['changeprice']) { ?>+<?php  } else { ?>-<?php  } ?>yen <?php  echo number_format(abs($item['changeprice']),2)?>
                    </span>
                    </td>
                </tr>
                <?php  } ?>
                ...
                <tr>
                    ...
                    <td  style='border:none;text-align:right;;'>
                        ...
                        <?php  if(0<$item['changedispatchprice']) { ?>+<?php  } else { ?>-<?php  } ?>yen <?php  echo abs($item['changedispatchprice'])?>
                        </span>
                    </td>
                </tr>
                <?php  } ?>
                <tr>
                    ...
                    <td style='border:none;text-align:right;font-weight:bold'>yen <?php  echo number_format($item['price']-$item['creditmoney']+$item['freight'],2)?></td>
                </tr>
            </table>">
                    <i class='fa fa-question-circle'></i></a>
                <?php  if($item['freight']>0) { ?>
                <br/>(含运费:yen <?php  echo number_format( $item['freight'],2)?>)
                <?php  } ?>
            </td>
            <td style='text-align:center' >
