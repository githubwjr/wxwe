...
<div class='page-header'>当前位置：<span class="text-primary">入口/分享设置</span></div>
<div class="page-content">
<form id="setform"  <?php if(cv('sign.set')) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" >

    <div class="form-group">
        <label class="col-lg control-label">在个人中心显示</label>
    ...
    <div class="form-group">
        <label class="col-lg control-label">在积分商城显示</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sign.set')) { ?>
    ...
    <div class="form-group">
        <label class="col-lg control-label">分享地址</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sign.set')) { ?>
