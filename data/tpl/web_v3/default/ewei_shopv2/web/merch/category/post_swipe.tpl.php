...
<div class="page-header">
	...
	当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>商户分组 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['groupname'];?>】<?php  } ?></small></span>
</div>
<div class="page-content">
	...
	<div class="form-group">
		<label class="col-lg control-label must">幻灯名称</label>
		<div class="col-sm-9 col-xs-12 ">
			<?php if( ce('merch.category.swipe' ,$item) ) { ?>
	...
	<div class="form-group">
		<label class="col-lg control-label">幻灯图片</label>
		<div class="col-sm-9 col-xs-12">
			<?php if( ce('merch.category.swipe' ,$item) ) { ?>
