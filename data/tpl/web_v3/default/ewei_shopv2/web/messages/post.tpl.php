...
<div class="page-header">
    当前位置：<span class="text-primary">消息群发任务编辑 <small><?php  if(!empty($item)) { ?>群发模板 <?php  echo $item['title'];?><?php  } ?></small></span>
</div>
<div class="page-content">
    ...
    <div class="form-group">
        <label class="col-lg control-label">发送消息类型</label>
        <div class="col-sm-9 col-xs-12" >
    ...
    <div class="form-group">
        <label class="col-lg control-label">发送进程数</label>
        <div class="col-lg col-lg-2col-xs-2">
...
<div class=" customermessage"  <?php  if(empty($item['messagetype'])) { ?>style="display:none"<?php  } ?>>
<div class="form-group">
    <label class="col-lg control-label"> 客服消息类型</label>
    <div class="col-sm-9 col-xs-12" >
        <?php if( ce('messages.template' ,$item) ) { ?>
        <label class="radio-inline coupon-radio">
...
<div class="news"  <?php  if(!empty($item['customertype'])) { ?>style="display:none"<?php  } ?>>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php  echo tpl_form_field_image2('send_thumb', $item['respthumb'])?>
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label">推送描述</label>
    <div class="col-sm-9 col-xs-12">
        <textarea name="send_desc" class="form-control" rows="5"  ><?php  echo $item['respdesc'];?></textarea>
    </div>
</div>
...
<script>
    require(['jquery','util'], function($, util){
        ...
        $(function(){
            util.emotion($('#emotion'),$('#content'),function (emotion_code) {
                var content = $('#content').val()+emotion_code;
                $('#content').val(content);
            });
        });
...
<div class="col-sm-9 col-xs-12">
    <textarea name="send_desc2" style="height: 150px;resize: none;" class="form-control" placeholder='支持<a href=""></a>标签' name="content" id="content" rows="5"><?php  echo $item['resdesc2'];?></textarea>
...
<div class="col-sm-9 col-xs-12">
    <textarea name="send_openid1" class="form-control" style="height:250px;" placeholder="请用半角逗号隔开OPENID, 如 aaa,bbb" id="value_1" rows="5"><?php  echo $send_openid1;?></textarea>
</div>
</div>
