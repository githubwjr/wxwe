...
<div class="page-content">
    ...
    <!--<div class="form-group">
        <label class="col-lg control-label">申请通知</label>
        <div class="col-sm-9 col-xs-12">
    ...
    <div class="form-group">
        <label class="col-lg control-label">申请结算通知</label>
        <div class="col-sm-9 col-xs-12">
    ...
    <!--    <div class="form-group">
            <label class="col-lg control-label">审核通知</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">打款通知</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">支付通知(管理端)</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">支付通知(用户端)</label>
            <div class="col-sm-9 col-xs-12">
