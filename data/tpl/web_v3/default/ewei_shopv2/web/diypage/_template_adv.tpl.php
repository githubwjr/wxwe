...
<script type="text/html" id="tpl_edit_menu">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <label class="radio-inline"><input type="radio" name="style" value="small-top" class="diy-bind" data-bind-child="params" data-bind="style" data-bind-init="true" <%if params.style=='small-top'%>checked="checked"<%/if%>>样式三</label>
        </div>
    </div>
                ...
                <div class="item" data-id="<%itemid%>">
                    ...
                    <div class="item-body">
                        ...
                        <div class="item-form">
                            ...
                            <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                                <input type="text" class="form-control input-sm diy-bind" data-bind-parent="<%itemid%>" data-bind-child="data" data-bind="linkurl" id="curl-<%itemid%>" placeholder="请选择链接或输入链接地址" value="<%item.linkurl%>" <%if item.click=='1'%>disabled<%/if%> />
