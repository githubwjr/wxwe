...
<div class="page-content">
    <div class='alert alert-primary'>请将公众平台模板消息所在行业选择为： IT科技/互联网|电子商务</div>
        ...
        <div class="panel panel-default">
            ...
            <div class='panel-body'>
                <div class="form-group">
                    <label class="col-lg control-label">商品兑换成功通知</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('creditshop.notice.edit')) { ?>
                        <input type="text" name="tm[new]" class="form-control" value="<?php  echo $set['tm']['new'];?>" />
                        <div class="help-block">通知公众平台模板消息编号: OPENTM413117078 或 业务处理通知  </div>
                        <?php  } else { ?>
            ...
            <div class='panel-body'>
                 <div class="form-group">
                    <label class="col-lg control-label">中奖结果通知</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('creditshop.notice.edit')) { ?>
                            <input type="text" name="tm[award]" class="form-control" value="<?php  echo $set['tm']['award'];?>" />
                            <div class="help-block">公众平台模板消息编号: OPENTM413117078 或 业务处理通知 </div>
                        <?php  } else { ?>
                ...
                <div class="form-group">
                    <label class="col-lg control-label">奖品兑换成功通知</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('creditshop.notice.edit')) { ?>
                ...
                <div class="form-group">
                    <label class="col-lg control-label">发货提醒</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('creditshop.notice.edit')) { ?>
