...
<div class="page-header">
    ...
    <?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>商品
        <small>
           ...
           <ul class="nav nav-arrow-next nav-tabs" id="myTab">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    ...
                    <?php  } ?>
                    <a class="btn btn-default" href="<?php  echo webUrl('creditshop/goods')?>">返回列表</a>
                </div>
            </div>
     </form>
</div>
         ...
         if(o.hasoption>0){
             ...
             if(o.allspecs){
                 ...
                 o.allspecs.forEach(function (e) {
                     ...
                     $specs += "<input name='spec_title[foxteam"+e.id+"]' type='text' class='form-control  spec_title' value='"+e.title+"' placeholder='规格名称 (比如: 颜色)'/>";
