...
<div class="form-group">
    <label class="col-lg control-label">会员组浏览权限</label>
    <div class="col-sm-9 col-xs-12 chks" >
		<?php if( ce('creditshop.goods' ,$item) ) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">会员组购买权限</label>
    <div class="col-sm-9 col-xs-12 chks" >
		<?php if( ce('creditshop.goods' ,$item) ) { ?>
