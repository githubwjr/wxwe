...
<div class="page-content">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button class="btn  btn-primary" type="submit"> 搜索</button>
                           <?php if(cv('dividend.apply.export')) { ?>
    ...
    <table class="table ">
        ...
        <tr style="background: #f7f7f7">
            ...
            <th>提现方式</th>
            <th>申请分红</th>
            <th><?php  if($status==3) { ?>实际到账<?php  } else { ?>实际分红<?php  } ?></br>已发送金额 (微信红包)</th>
            <th>提现手续费</th>
            <?php  if($status==-1) { ?>
            <?php  $col++?>
            <th>无效时间</th>
        ...
        <tr class="trorder" style="border-top: none;">
            ...
            <td class="text-danger"><?php  echo $row['dividend'];?></td>
            ...
            <td>
                <?php if(cv('dividend.apply.detail')) { ?>
