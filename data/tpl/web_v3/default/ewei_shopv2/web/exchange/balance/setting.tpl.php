...
<div class="form-group" style="padding: 30px 10px 0"></div>
    ...
    <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade in active" id="home">
                <form <?php  if($id>0) { ?>action="<?php  echo webUrl('exchange/balance/edit',array('id'=>$id),true);?>"<?php  } else { ?>action="<?php  echo webUrl('exchange/balance/add',array(),true);?>"<?php  } ?> method="post" class="form-horizontal form-validate"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <label for="bdadd" class="radio-inline"><input type="radio" name="type" class="type" value="1" id="bdadd" onclick="$('#zhiding').show();$('#suiji').hide();" <?php  if($setting['type']!=2) { ?>checked<?php  } ?>> 指定余额兑换</label>
                        <label for="adadd" class="radio-inline"><input type="radio" name="type" class="type" value="2" id="adadd" onclick="$('#zhiding').hide();$('#suiji').show();" <?php  if($setting['type']==2) { ?>checked<?php  } ?>> 随机余额兑换</label>
                        <label for="chongzhi" class="radio-inline"><input type="radio" name="type" class="type" value="3" id="chongzhi" onclick="$('#zhiding').show();$('#suiji').hide();" <?php  if($setting['type']==3) { ?>checked<?php  } ?>> 余额充值</label>
                    </div>
                </div>
                <div class="form-group" id="zhiding" <?php  if($setting['type']==2) { ?>style="display: none;"<?php  } ?>>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class="input-group  fixsingle-input-group">
                            <input type="text" class="form-control" name="value" value="<?php  echo $setting['balance'];?>">
        ...
        <div class="tab-pane fade" id="message">
            <form action="<?php  if($setting['code_type'] != 3) { ?><?php  echo webUrl('exchange/goods/setting',array('id'=>$id),1);?><?php  } else { ?><?php  echo webUrl('exchange/goods/addreply',array('id'=>$id),1);?><?php  } ?>" method="post"
                ...
                <div class="form-group">
                    <label class="col-lg control-label">兑换入口</label>
                    <div class="col-sm-9 col-xs-12">
                ...
                <div id="yulan" <?php  if($setting['reply_type'] == 1) { ?>style="display: none;"<?php  } ?>>
                    ...
                    <div class="col-sm-7" style="margin-left: 30px">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <textarea name="balancecontent" id="balancecontent" cols="30" rows="5"
                                          class="form-control"  id="balancecontent" maxlength="30"><?php  echo $setting['content'];?></textarea>
                            </div>
                        </div>
                        <?php  if($setting['code_type'] == 3) { ?>
                        <div class="form-group">
