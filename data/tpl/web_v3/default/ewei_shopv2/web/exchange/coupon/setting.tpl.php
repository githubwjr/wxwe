...
<div id="myTabContent" class="tab-content">
    ...
    <div class="tab-pane fade in active" id="home">
        <form <?php  if($id>0) { ?>action="<?php  echo webUrl('exchange/coupon/edit',array('id'=>$id),true);?>"<?php  } else { ?>action="<?php  echo webUrl('exchange/coupon/add',array(),true);?>"<?php  } ?> method="post" class="form-horizontal form-validate"
                            ...
                            <div id="goods">
                                ...
                                <div style="max-height:500px;overflow:auto;min-width:500px;">
                                    <table class="table">
                                        ...
                                        <?php  if(is_array($all)) { foreach($all as $key => $value) { ?>
                                        <tr>
                                            <td><?php  echo ++$a?></td>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <label for="bdadd" class="radio-inline"><input type="radio" name="type" class="type" value="1" id="bdadd" <?php  if($setting['type']!=2) { ?>checked<?php  } ?>> 发放全部选定优惠券</label>
                    <label for="adadd" class="radio-inline"><input type="radio" name="type" class="type" value="2" id="adadd" <?php  if($setting['type']==2) { ?>checked<?php  } ?>> 随机发放一个优惠券</label>
                </div>
            </div>
            <div class="form-group" id="shangpinadd">
                <label class="col-lg control-label">选择指定优惠券</label>
                <div class="col-sm-9 col-xs-12">
                    <a  onclick="$('#myModal').modal('show')" class="form-control count_coupon">点击选择优惠券</a>
                </div>
            </div>
            <div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9  col-xs-12">
        ...
        <a class="btn btn-default" href="<?php  echo webUrl('exchange/balance')?>">返回列表</a>
    </div>
</div>
</form>
</div>
    ...
    <form action="<?php  if($setting['code_type'] != 3) { ?><?php  echo webUrl('exchange/goods/setting',array('id'=>$id),1);?><?php  } else { ?><?php  echo webUrl('exchange/goods/addreply',array('id'=>$id),1);?><?php  } ?>" method="post"
        ...
        <script>
            ...
            $('.onoffswitch-checkbox').change(function () {
                var count_coupon=$('.onoffswitch-checkbox:checked').length;
                if(count_coupon>0){
                    $('.count_coupon').html('点击选择优惠券,已选择 <span class="text-danger">'+count_coupon+'</span> 张优惠券');
                }else{
                    $('.count_coupon').html('点击选择优惠券');
                }
            });
