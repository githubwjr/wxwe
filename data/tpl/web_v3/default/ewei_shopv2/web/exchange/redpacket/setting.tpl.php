...
<div class="page-header" style="margin-bottom:0">
    当前位置：<span class="text-primary"><?php  if($id>0) { ?>编辑红包兑换任务<?php  } else { ?>添加红包兑换任务<?php  } ?></span>
</div>
...
<div id="myTabContent" class="tab-content">
    ...
    <div class="tab-pane fade in active" id="home">
        <form <?php  if($id>0) { ?>action="<?php  echo webUrl('exchange/redpacket/edit',array('id'=>$id),true);?>"<?php  } else { ?>action="<?php  echo webUrl('exchange/redpacket/add',array(),true);?>"<?php  } ?> method="post" class="form-horizontal form-validate"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <label for="bdadd" class="radio-inline">
                        <input type="radio" name="type" class="type" value="1" id="bdadd" onclick="$('#zhiding').show();$('#suiji').hide();" <?php  if($setting['type']!=2) { ?>checked<?php  } ?>> 指定红包兑换</label>
                    <label for="adadd" class="radio-inline">
                        <input type="radio" name="type" class="type" value="2" id="adadd" onclick="$('#zhiding').hide();$('#suiji').show();" <?php  if($setting['type']==2) { ?>checked<?php  } ?>> 随机红包兑换</label>
            ...
            <div class="col-sm-9 col-xs-12">
                <div class="input-group fixsingle-input-group">
                    <input type="text" class="form-control" name="value" value="<?php  echo $setting['red'];?>">
...
<div class="form-group">
    <label class="col-lg control-label">开启口令红包</label>
    <div class="col-sm-9  col-xs-12">
        <label for="kouling" class="checkbox-inline" onclick="kaka()"><input type="checkbox" name="kouling" id="kouling" <?php  if(!empty($setting['kouling'])) { ?>checked<?php  } ?> value="1"> 开启口令红包</label>
    </div>
</div>

<div class="well" <?php  if(empty($setting['kouling'])) { ?>style="display: none"<?php  } ?> id="kouling-group">
<?php  $kouling = unserialize($setting['kouling']);?>
    <div class="form-group">
        <label class="col-lg control-label must">触发关键字</label>
        <div class="col-sm-9  col-xs-12">
            <input type="text" class="form-control" name="koulingstart" value="<?php  echo $setting['koulingstart'];?>">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg control-label must">触发时提示文字：</label>
        <div class="col-sm-9  col-xs-12">
            <input type="text" class="form-control" name="chufa" value="<?php  echo $setting['chufa'];?>">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg control-label must">退出关键字</label>
        <div class="col-sm-9  col-xs-12">
            <input type="text" class="form-control" name="koulingend" value="<?php  echo $setting['koulingend'];?>">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg control-label must">退出时提示文字：</label>
        <div class="col-sm-9  col-xs-12">
            <input type="text" class="form-control" name="chufaend" value="<?php  echo $setting['chufaend'];?>">
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9  col-xs-12">
        ...
        <a class="btn btn-default " href="<?php  echo webUrl('exchange/redpacket')?>">返回列表</a>
    </div>
</div>
</form>
</div>
        ...
        <div id="yulan" <?php  if($setting['reply_type'] == 1) { ?>style="display: none;"<?php  } ?>>
            ...
            <div class="col-sm-7" style="margin-left: 30px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                                <textarea name="balancecontent" id="balancecontent" rows="5"
