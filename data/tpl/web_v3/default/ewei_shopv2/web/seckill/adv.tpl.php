        ...
        <table class="table table-responsive table-hover" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(cv('seckill.adv.edit')) { ?>
                            <a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('seckill/adv/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                        <?php  } else { ?>
                    ...
                    <td>
                        ...
                        <td style="text-align:left;">
                            <?php if(cv('seckill.adv.view|seckill.adv.edit')) { ?>
                                <a href="<?php  echo webUrl('seckill/adv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm btn-op btn-operation">
                                    <span data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php if(cv('seckill.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
                                      <?php if(cv('seckill.adv.edit')) { ?>
