...
<div class="page-header">
    当前位置：<span class="text-primary">回收站</span>
</div>
<div class="page-content">
    <form action="" method="post" class="form-horizontal form-search" role="form">
        ...
        <div class="input-group pull-right col-md-6">
            <input type="text" class=" form-control" name="search" value="<?php  echo $_GPC['search'];?>" placeholder="商品名称" style="width: 300px;float: right;"> <span class="input-group-btn">
    ...
    <table class="table table-hover table-responsive">
        ...
        <tr>
            ...
            <td  style="overflow:visible;position:relative">
                <?php if(cv('bargain.recycle')) { ?>
                <a  class='btn btn-default btn-sm btn-op btn-operation' data-toggle="ajaxRemove" href="<?php  echo webUrl('bargain/recover',array('id'=>$value['id']));?>" data-confirm='确认恢复此商品？'>
                ...
                <?php  } ?>
                <?php if(cv('bargain.delete')) { ?>
                <a  class='btn btn-default btn-sm btn-op btn-operation' data-toggle="ajaxRemove" href="<?php  echo webUrl('bargain/delete',array('id'=>$value['id']));?>" data-confirm='确认删除此商品？'>
