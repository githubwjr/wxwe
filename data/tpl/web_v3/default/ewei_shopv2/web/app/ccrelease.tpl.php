...
<div class="page-content">
        ...
        <?php  } else { ?>
            ...
            <div class="wxapp-detail">
                ...
                <div class="qrcode">
                    ...
                    <?php  } ?>
                    <!--img src="<?php echo ($release['audit_status']==1)? '../addons/ewei_shopv2/plugin/app/static/images/qrcode.png': webUrl('app/ccrelease/getqrCode',array('url'=>$release['qrcode']))?>" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'" /-->
                    <img src="<?php echo ($release['audit_status']==1)? '../addons/ewei_shopv2/plugin/app/static/images/qrcode.png': EWEI_SHOPV2_AUTH_WXAPP.'&do=qrcode&url='.urlencode($release['qrcode'])?>" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'" />
                </div>
                <?php  if($release['audit_status']>1) { ?>
                ...
                <?php  } else if($release['audit_status']==2 || $release['audit_status']==1 || $release['audit_status']==0) { ?>
    ...
    <?php  } ?>
	 ...
	 <div  style="color:red;margin-top:100px;font-size:12px;" class="btn btn-default"> 提示：3.9.20版本小程序无变动，无需重新提交发布</div>
    ...
    <script type="text/javascript">
        ...
        $(".btn-audit").click(function () {
            ...
            tip.confirm('确定要'+text+'吗？', function () {
                ...
                $.post(biz.url('app/ccrelease/audit'), {
                    action: action
                }, function (ret) {
                    if(ret.status!=1){
        ...
        function authFun() {
            var url = biz.url('app/ccrelease/auth');
            window.open(url);
