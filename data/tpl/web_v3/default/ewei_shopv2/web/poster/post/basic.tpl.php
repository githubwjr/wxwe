...
<div class="form-group" id="autogroup" style="<?php  if($item['type']==4) { ?>display: block;<?php  } else { ?>display: none;<?php  } ?>">
<!-- <div class="form-group" style="display: block;"> -->
    <label class="col-lg control-label">会员是否自动分组</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('poster' ,$item) ) { ?>
        <label class="radio-inline">
...
<div class="form-group" id="membergroup" <?php  if($item['type']!=4) { ?>style="display:none;"<?php  } ?>>
<label class="col-lg control-label">指定会员分组</label>
<div class="col-sm-9 col-xs-12">
    <?php if( ce('poster' ,$item) ) { ?>
