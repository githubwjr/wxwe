...
<div class="page-header">
    ...
    <span>全订单数:  <span class='text-danger'><?php  echo $member['ordercount0'];?></span> 订单金额:  <span class='text-danger'><?php  echo "($total"."单".",$totalmoney"."￥)"?></span> <?php  if(!empty($magent['nickname'])) { ?>订单推广人:  <span class='text-danger'><?php  echo $magent['nickname'];?></span><?php  } ?></span>
</div>
