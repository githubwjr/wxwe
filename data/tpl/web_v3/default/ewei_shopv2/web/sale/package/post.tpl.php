...
<div class="page-header">
    当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>套餐 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['title'];?>】<?php  } ?></small></span>
</div>
    ...
    <div class="tab-content ">
        <div class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg control-label">套餐缩略图</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if( ce('sale.package' ,$item) ) { ?>
                ...
                <div class="form-group cgt cgt-0">
                    <label class="col-lg control-label must">套餐价格</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if( ce('sale.package' ,$item) ) { ?>
                ...
                <div class="col-sm-5 col-xs-5">
                    ...
                    <div class="input-group">
                        <span class='input-group-addon' style='border:none'><label class="radio-inline" style='margin-top:-7px;' ><input type="radio" name="dispatchtype" value="1" <?php  if(!empty($item['dispatchtype'])) { ?>checked="true"<?php  } ?>   /> 运费模板</label></span>
                        <span class='input-group-addon' style='border:none'><label class="radio-inline" style='margin-top:-7px;' ><input type="radio" name="dispatchtype" value="0" <?php  if(empty($item['dispatchtype'])) { ?>checked="true"<?php  } ?>   /> 统一运费</label></span>
                        <input type="text" class="form-control" name="freight" value="<?php  echo $item['freight'];?>"/>
                        <span class="input-group-addon">元</span>
                    </div>
                    <span class="help-block text-danger">如果所选商品中包含多商户商品，那么必须选择运费模板（多商户商品运费按照商品本身设置的运费计费）</span>
                ...
                <div class="form-group">
                    <label class=" col-lg control-label">货到付款</label>
