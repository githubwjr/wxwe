...
<form action="" <?php if( ce('article' ,$article) ) { ?>method="post" <?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
	...
	<div class="page-header">
		当前位置：<span class="text-primary"><?php  if(!empty($article['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>文章 <small><?php  if(!empty($article['id'])) { ?>编辑【<?php  echo $article['article_title'];?>】<?php  } ?></small></span>
	</div>
