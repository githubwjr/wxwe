        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <select class="select2 is_advanced" name="article_advanced">
                    ...
                    <?php  if(is_array($template_list['article'])) { foreach($template_list['article'] as $template_val) { ?>
                    <option value="<?php  echo $template_val['id'];?>" <?php  if($set['tm']['article_advanced'] == $template_val['id'] ) { ?>selected<?php  } ?>><?php  echo $template_val['title'];?></option>
                    <?php  } } ?>
                </select>
                <span style="text-align: right;" class="is_advanced">
                        <label class="notice-default">
                            ...
                            <input class="js-switch small checkone" data-type="tpl-advanced" data-tag="article"  type="checkbox" value="<?php  echo intval($article_sys['article_close_advanced'])?>" <?php  if(empty($article_sys['article_close_advanced'])) { ?>checked<?php  } ?>/>
                        </label>
