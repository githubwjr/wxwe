    ...
    <div class="diy-editor form-horizontal <%if selected=='0'%>active<%/if%>" data-id="0">
        ...
        <div class="editor-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control input-sm bind"  name="title" placeholder="页面名称" value="<%title%>" data-bind="title" maxlength="20" id="name" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control input-sm bind"  name="pagetitle" placeholder="页面标题" value="<%pagetitle%>" data-bind="pagetitle" data-bind-element="#page-title" maxlength="20" />
                </div>
            </div>
            <div class="form-group">
                                ...
                                <div class="item" data-index="<%index%>">
                                    ...
                                    <div class="item-form">
                                        ...
                                        <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                                            ...
                                            <span class="input-group-addon btn btn-default" data-toggle="selectUrl"  <?php  if($type=="1") { ?>data-platform="wxapp"  <?php  } ?> data-input="#adv-link-<%index%>">选择链接</span>
                                        </div>
                                    </div>
                                </div>
                            <%/each%>
                        ...
                        <%each shopmenu as nav index%>
                            <div class="item" data-index="<%index%>">
                                ...
                                <div class="item-image square shopicon">
                                    <p style="color: <%style.menuicon%>;">
                                        <i class="<?php  if($type==1) { ?>icox  <%nav.icon%><?php  } else { ?>icon <%nav.icon%><?php  } ?>" id="shopmenu-show-<%index%>"></i>
                                    </p>
                                ...
                                <div class="item-form">
                                    <div class="input-group" style="margin-bottom:0px; ">
                                        ...
                                        <span class="input-group-addon btn btn-default" <?php  if($type==1) { ?> data-toggle="selectIcon3" <?php  } else { ?> data-toggle="selectIcon" <?php  } ?> data-input="#shopmenu-<%index%>" data-element="#shopmenu-show-<%index%>">选择图标</span>
                                    </div>
                                    <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                                        ...
                                        <span class="input-group-addon btn btn-default" data-toggle="selectUrl"   <?php  if($type=="1") { ?>data-platform="wxapp" data-type="menu" <?php  } ?> data-input="#shopmenu-link-<%index%>">选择链接</span>
                                    </div>
                                </div>
                            </div>
                        <%/each%>
                                ...
                                <div class="item" data-index="<%index%>">
                                    ...
                                    <div class="item-form">
                                        ...
                                        <div class="input-group" style="margin-top:10px; margin-bottom:0px; ">
                                            ...
                                            <span class="input-group-addon btn btn-default" data-toggle="selectUrl" <?php  if($type=="1") { ?>data-platform="wxapp" data-type="menu" <?php  } ?> data-input="#notice-indput-<%index%>">选择链接</span>
                                        </div>
                                    </div>
                                </div>
                            <%/each%>
        ...
        <div class="editor-body">
            ...
            <%if datas[dataIndex].datatype==0%>
                <div class="form-items" data-type="datas">
                    <div class="inner" id="form-items-datas">
