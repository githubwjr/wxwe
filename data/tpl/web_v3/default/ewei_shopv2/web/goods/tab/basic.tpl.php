<?php defined('IN_IA') or exit('Access Denied');?><div class="region-goods-details row">
    ...
    <?php  } ?>
          <!--分享海报-->
<div class="form-group">
    <label class="col-sm-2 control-label must">定制海报图片</label>
    <div class="col-sm-9 col-xs-12 gimgs">
        <?php  echo tpl_form_field_image('thumbss',$item['thumbs'])?>
        <span class="help-block image-block">定制海报，建议尺寸640 * 1008 。</span>
    </div>
</div>
