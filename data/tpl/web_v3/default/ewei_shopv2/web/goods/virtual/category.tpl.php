...
<div class="page-header">当前位置：<span class="text-primary">虚拟卡密分类</span></div>
        ...
        <table class="table table-hover  table-responsive">
            ...
            <tbody id='tbody-items'>
                ...
                <tr>
                    ...
                    <td>
                          <?php if(cv('goods.virtual.category.delete')) { ?>
                                <a data-toggle="ajaxRemove" href="<?php  echo webUrl('goods/virtual/category/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm btn-operation btn-op" data-confirm="确认删除此分类?">
