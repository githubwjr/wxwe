...
<div class="page-header">
    当前位置：<span class="text-primary"><?php  if(!empty($item['lottery_id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>抽奖 <small><?php  if(!empty($item['lottery_id'])) { ?>修改【<?php  echo $item['lottery_title'];?>】<?php  } ?></small></span>
</div>
