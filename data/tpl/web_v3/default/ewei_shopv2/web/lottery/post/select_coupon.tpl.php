<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane" id="sut_coupon">
    ...
    <div id="selected_coupon" class="form-control-static">
    </div>
    <div id="select-coupon-list"></div>
    <p class="text-danger text-center" id="couponerror"></p>
</div>
