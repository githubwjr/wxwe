...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
            ...
            <span class="input-group-addon" style="padding: 0px;"><img src="<?php  if(!empty($item['lottery_icon'])) { ?><?php  echo $item['lottery_icon'];?><?php  } else { ?><?php  } ?>" id="showimg" width="30px" height="28px" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"></span>
            <span class="input-group-addon" data-toggle="selectImg" data-input="#lottery_icon" data-img="#showimg" data-full="1">选择图片</span>
        </div>
        <?php  } else { ?>
        <div class='form-control-static'><img src="<?php  if(!empty($item['lottery_icon'])) { ?><?php  echo $item['lottery_icon'];?><?php  } else { ?><?php  } ?>"  width="30px" height="30px" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"><?php  if(!empty($item['lottery_title'])) { ?><?php  echo $item['lottery_title'];?><?php  } else { ?>暂无标题<?php  } ?></div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label must">活动详情页背景图</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
        <div class="input-group">
            ...
            <span class="input-group-addon" style="padding: 0px;"><img src="<?php  if(!empty($item['lottery_banner'])) { ?><?php  echo $item['lottery_banner'];?><?php  } else { ?><?php  } ?>" id="showbanner" width="30px" height="28px" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"></span>
            <span class="input-group-addon" data-toggle="selectImg" data-input="#lottery_banner" data-img="#showbanner" data-full="1">选择图片</span>
        </div>
        <?php  } else { ?>
        <div class='form-control-static'><img src="<?php  if(!empty($item['lottery_banner'])) { ?><?php  echo $item['lottery_banner'];?><?php  } else { ?><?php  } ?>"  width="28px" height="30px" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"></div>
        <?php  } ?>
    </div>
</div>

<div class="form-group">
    <label class="col-lg control-label must">活动期限</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
...
<?php  if($_GPC['lottery_type'] == 1) { ?>
<div class="form-group">
    <label class="col-lg control-label must">奖励信息显示</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
        <?php  echo tpl_form_field_daterange('award_time', array('starttime'=>date('Y-m-d H:i', $award_starttime),'endtime'=>date('Y-m-d H:i', $award_endtime)),true);?>
        <span class='help-block'>显示自定义时间段内的奖励信息</span>
        <?php  } else { ?>
        <div class='form-control-static'><?php  echo date('Y-m-d H:i', $award_starttime).'-'.date('Y-m-d H:i', $award_endtime);?></div>
        <?php  } ?>
    </div>
</div>
<?php  } ?>
<div class="form-group">
    <label class="col-lg control-label must">活动奖励有效期限</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">场景设置</label>
    <?php if(cv('lottery.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">场景条件</label>
    <?php if(cv('lottery.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">不能参加活动提示</label>

    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
        <textarea name="lottery_cannot" class="form-control" rows="5" ><?php  if($item['lottery_cannot']) { ?><?php  echo $item['lottery_cannot'];?><?php  } else { ?>您没有参与抽奖的机会..<?php  } ?></textarea>
...
<div class="form-group">
    <label class="col-lg control-label">奖励商品参与分销</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
