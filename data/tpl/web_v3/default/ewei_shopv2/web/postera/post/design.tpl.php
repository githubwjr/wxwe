                                    ...
                                    <td style='width:320px;padding:10px;' valign='top'>
                                        <div id='postera'>
                                          ...
                                          <div class="drag" type="<?php  echo $d['type'];?>" index="<?php  echo $key+1?>" style="zindex:<?php  echo $key+1?>;left:<?php  echo $d['left'];?>;top:<?php  echo $d['top'];?>;
                                               ...
                                               > 
                                               <?php  if($d['type']=='qr') { ?>
                                                 <img src="../addons/ewei_shopv2/plugin/postera/static/images/qr.jpg" />
                                               <?php  } else if($d['type']=='head') { ?>
                                                  <img src="../addons/ewei_shopv2/plugin/postera/static/images/head.jpg" />
                                                <?php  } else if($d['type']=='img' || $d['type']=='thumb') { ?>
                                                  <img src="<?php echo empty($d['src'])?'../addons/ewei_shopv2/plugin/postera/static/images/img.jpg':tomedia($d['src'])?>" />
