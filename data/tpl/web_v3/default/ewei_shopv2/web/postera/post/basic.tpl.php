...
<div class="form-group">
    <label class="col-lg control-label">活动有效期</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('postera' ,$item) ) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">活动未开始提示</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('postera' ,$item) ) { ?>

        <textarea name="starttext" class="form-control" rows="5"><?php  echo $item['starttext'];?></textarea>
...
<div class="form-group">
    <label class="col-lg control-label">活动结束提示</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('postera' ,$item) ) { ?>

        <textarea name="endtext" class="form-control"  rows="5"><?php  echo $item['endtext'];?></textarea>
