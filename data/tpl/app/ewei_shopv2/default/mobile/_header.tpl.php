...
<!--   <script src="../addons/ewei_shopv2/static/js/dist/foxui/js/foxui.min.js"></script>-->
        ...
        <?php  if(is_h5app()) { ?>
            <style>
                .page-shop-goods_category .fui-header, .fui-page-group.statusbar .fui-statusbar, .fui-header, .page-goods-list .fui-header {background-color: <?php  echo $_W['shopset']['wap']['headerbgcolor'];?>;padding-top: constant(safe-area-inset-top);}
                ...
                <?php  if(is_android()) { ?>.head-menu-mask, .fui-mask, .fui-mask-m, .order-list-page .fui-tab {top: 3.2rem;}.head-menu{top: 3.65rem}.diy-fixedsearch{top:3.2rem !important;}.fui-searchbar-bar{top:1rem}<?php  } ?>
              <?php  if(is_ios()) { ?>.diy-fixedsearch{top:3.2rem;} .fui-searchbar-bar{top:1rem} .head-menu-mask, .fui-mask, .fui-mask-m, .order-list-page .fui-tab {top: 3.2rem;}.head-menu{top: 3.65rem}
 ...
 <?php  if(is_ios()) { ?>
      <style type="text/css">
            ...
            .fui-page-group.statusbar .fui-header {
                margin-top: 0rem;
            }
            .fui-page-group.statusbar .fui-header ~ .fui-content,
            .fui-page-group.statusbar .fui-header ~ .fui-content.margin {
                top: 2rem;
            }
         .fui-page-group.statusbar .page-goods-list .fui-content {
                top:5.4rem;
            }

            .fui-page-group.statusbar .order-list-page .fui-content {
                top: 5.2rem;
            }
            .fui-page-group.statusbar .page-goods-detail .detail-block {
                top:1rem;
            }
        </style>
<?php  } ?>
    ...
    <body ontouchstart>
		...
		<div id="homeSta" class='fui-page-group <?php  if(is_h5app()) { ?>statusbar<?php  } ?>'>
            <?php  if(is_h5app()) { ?>
