...
<style>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#fuceng").click(function(){
                htmlobj=$.ajax({url:"<?php  echo mobileUrl('bargain/bargain');?>&id=<?php  echo $id;?>&ajax=151",async:false});
    ...
    <script language="javascript" type="text/javascript">
        ...
        window.setInterval(function(){ShowCountDown(<?php  echo $year;?>,<?php  echo $month;?>,<?php  echo $day;?>,<?php  echo $hour;?>,<?php  echo $minute;?>,<?php  echo $second;?>,<?php  echo $status;?>,'divdown1');}, interval);
    </script>
    ...
    <div class='fui-page creditshop-detail-page' style="background: #fff;position: fixed">
        ...
        <div class='fui-content' style="padding-bottom: 2.5rem;position: absolute">
            <div class="bargain-shop">
                <div class='user'>
                    <img src="<?php  echo $res['head_image'];?>" alt="">
                    <text><?php  echo $res['nickname'];?></text>
                </div>
                <a class='goodsinfo flex' href="<?php  echo mobileUrl('bargain/detail',array('id'=>$res2['id']));?>" data-nocache="true" class="external">
                    ...
                    <div class='goodsinner'>
                        <div class='title'><?php  echo $res2['title'];?></div>
                        <div class='price'>原价:&yen;<?php  echo $res2['start_price'];?></div>
                        <div class='status'>库存<?php  echo $res2['stock'];?>  | 已售<?php  echo $ewei_detail['sales']+$ewei_detail['salesreal']?></div>
                    </div>
                </a>
                <div class='prices <?php  if($trade_swi==2) { ?>delay<?php  } ?>'>
                    <div class='current'>
                        &yen;</i><?php  echo $res['now_price'];?><text>当前价</text>
                    </div>
                    <div class='cut'>
            ...
            <div class="bargain-list fui-cell-group">
                <div class="bargain-list-top flex" id="bargainTab">
                    ...
                    <?php  if($account_set['partin'] > -10000) { ?><a href="javascript:void(0);" data="list">参与榜</a><?php  } ?>
                </div>
                <div class="bargain-list-content" id="bargainTabContent">
                    <div class="bargain-list-content-item active" id="family">
                        <ul class="bargain-list-content-ul">
                            <?php  if(!empty($res3)) { ?>
                            <?php  if(is_array($res3)) { foreach($res3 as $key => $value) { ?>
                            <div class='fui-cell'>
                                <div class='fui-cell-label'>
                                    <img src="<?php  echo $value['head_image'];?>" alt="">
                                </div>
                                <div class='fui-cell-info'>
                                    <div class='title'><?php  echo $value['nickname'];?></div>
                                    <div class='text'><?php  echo date('m/d  H:i',strtotime($value['bargain_time']));?></div>
                                </div>
                                <div class='fui-cell-remark noremark danger'>
                                    <?php  if($value['bargain_price'] <= 0) { ?><?php  echo $value['bargain_price'];?><?php  } ?>
                                    <?php  if($value['bargain_price'] > 0) { ?> <font color="green">+<?php  echo $value['bargain_price'];?></font><?php  } ?>
                                </div>
                            </div>
                            <?php  } } ?>
                            <?php  } ?>
                    ...
                    <div class="bargain-list-content-item" id="rule"  style="margin:0cm 1cm 0cm 1cm;margin-top: 20px">
                        <?php  if($res2['rule'] != null) { ?><?php  echo htmlspecialchars_decode($res2['rule']);?><?php  } ?>
                        <?php  if($res2['rule'] == null) { ?><?php  echo htmlspecialchars_decode($account_set['rule']);?><?php  } ?>
                    </div>
                    <?php  if($account_set['partin'] > -10000) { ?><div class="bargain-list-content-item" id="list">
                        <ul class="bargain-list-content-ul">
                            <?php  if(is_array($res4)) { foreach($res4 as $key => $value) { ?>
                            <div class='fui-cell'>
                                <div class='fui-cell-label'>
                                    <img src="<?php  echo $value['head_image'];?>" alt="">
                                </div>
            ...
            <div class="fui-navbar flex">
                <?php  if($trade_swi==0) { ?><a href="<?php  echo mobileUrl('order/create',array('bargainid'=>$res['id'],))?>" class="left" data-nocache="">立即购买</a><?php  } ?>
                <?php  if($trade_swi==1) { ?><a href="#" class="left " style="background-color:#ccc;" data-nocache="true">已经下单</a><?php  } ?>
                <?php  if($trade_swi==2) { ?><a href="#" class="left " style="background-color:#ccc;" data-nocache="true">已经结束</a><?php  } ?>
                <?php  if($trade_swi==3) { ?><a href="#" class="left " style="background-color:#ccc;" data-nocache="true">库存不足</a></span><?php  } ?>
                <?php  if($trade_swi==4) { ?><a href="#" class="left " style="background-color:#ccc;" data-nocache="true">没到底价</a><?php  } ?>
                <?php  if($trade_swi==1) { ?><a href="<?php  echo mobileUrl('order/detail',array('id'=>$res['order']));?>" class="right " data-nocache="true"><i class="icon icon-cart"></i> 查看订单</a><?php  } ?>
                <?php  if($myself_swi && $trade_swi!=1) { ?><a onclick="bargain()" class="right" id="fuceng"><i class="fu"></i>砍一刀</a><?php  } ?>
                <?php  if(!$myself_swi && $trade_swi!=1 && $endStauts == 0) { ?>
                    <a href="javascript:void(0)" onclick="$('#share').show()" class="right "><i class="fu"></i>找人帮砍</a>
                <?php  } else if($endStauts == 1) { ?>
            ...
            <?php  if($swi === 222) { ?>
            <div class="fui-navbar flex">
                <span><a href="<?php  echo mobileUrl('bargain/detail')?>&id=<?php  echo $res2['id'];?>" class="left external">我也要砍</a></span>
...
<div style="display: none;" id="bargainres">
    <div class='content'>
        ...
        <img src="../addons/ewei_shopv2/static/images/cutsuccess.png" alt="">
...
<div>
    <div style="position: absolute;top: 5rem;z-index: 2;width: 70%;left:15%;height: 70vw;text-align: center">
        ...
        <img src="<?php  echo $isFollowed['1'];?>" alt="" width="100%">
...
<div style="display: none" id="share">
    <?php  if(empty($account_set['sharestyle'])) { ?>
    <div style="position: absolute;top: 5rem;z-index: 2;width: 70%;left:15%;height: 70vw;text-align: center">
