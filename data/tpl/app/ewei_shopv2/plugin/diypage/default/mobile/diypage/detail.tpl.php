...
<div class='fui-page fui-page-current  page-goods-detail' id='page-goods-detail-index'>
    ...
    <!--参数已完成-->
    <?php  if(count($params)>0) { ?>
    <div class="fui-content param-block <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>" style="bottom: 0;">
...
<?php  } else { ?>
<?php  echo $commission_data['qrcodeshare'];?><?php  echo $commission_data['isagent'];?>
<?php  if($commission_data['qrcodeshare'] > 0 && $commission_data['isagent'] == 1) { ?>
        <i class="" id="alert-click" style="position: fixed;
            top: 70px;
            right: 30px;">
            <img src="/hb.png" style="
            width: 100%;
            height: 100%;
        ">
        </i>
