<?php defined('IN_IA') or exit('Access Denied');?><?php  if(!empty($diyitem['data'])) { ?>
    ...
    <?php  } else { ?>
        <div class="swiper swiper-<?php  echo $diyitemid;?>" data-element=".swiper-<?php  echo $diyitemid;?>" data-view="<?php  echo $diyitem['params']['rownum'];?>" data-btn="true">
            <div class="swiper-container fui-picturew row-<?php  echo $diyitem['params']['rownum'];?>" style="padding: <?php  echo $diyitem['style']['paddingtop'];?>px <?php  echo $diyitem['style']['paddingleft'];?>px; background: <?php  echo $diyitem['style']['background'];?>;<?php  if($diyitem['params']['rownum'] ==2) { ?>height: 10.2rem;<?php  } ?>
            <?php  if($diyitem['params']['rownum'] ==3) { ?>height: 7.15rem;<?php  } ?>  <?php  if($diyitem['params']['rownum'] ==4) { ?>height: 5.6rem;<?php  } ?>">
