...
<div class="fui-page fui-page-current page-commission-shares">
    ...
    <div class="fui-content">
        ...
        <div class="fui-list-group">
            <div class="fui-list">
                ...
                <div class="fui-list-inner">
                    <div class="row">
                        <div class="row-text"><?php  echo $goods['title'];?></div>
        ...
        <div class="fui-list-group">
            ...
            <div class="fui-list">
                <div class="fui-list-inner">
                    <div class="subtitle" style="white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-o-pre-wrap;word-wrap:break-word;"><?php  echo $set['qrcode_content'];?>
                    </div>
                </div>
            </div>
            <?php  } ?>
            <div class="fui-list">
                <div class="fui-card">
                    <div class="fui-card-content" style="white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-o-pre-wrap;word-wrap:break-word;">说明：<br/><?php  if(empty($set['qrcode']) || (!empty($set['qrcode'])&&empty($set['qrcode_remark']))) { ?>分享后会带有独有的推荐码，您的好友访问之后，系统会自动检测并记录客户关系。如果您的好友已被其他人抢先发展成了客户，他就不能成为您的客户，以最早发展成为客户为准。<?php  } else { ?><?php  echo $set['qrcode_remark'];?><?php  } ?>
                    </div>
                </div>
            </div>
