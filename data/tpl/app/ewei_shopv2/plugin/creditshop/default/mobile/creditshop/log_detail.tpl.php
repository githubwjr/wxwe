    ...
    <div class='fui-content navbar'>
        <div class='fui-list-group result-list'>
            <div class='fui-list order-status'>
                <div class='fui-list-inner'>
                    ...
                    <div class='text'>
                        商品总额: <?php  echo $ordercredit;?><?php  echo $_W['shopset']['trade']['credittext'];?>
                        <?php  if($ordermoney > 0) { ?> + &yen; <?php  echo $ordermoney;?><?php  } ?>
        ...
        <div class='fui-cell-group price-cell-group'>
            <div class="fui-cell">
                ...
                <div class="fui-cell-info"></div>
                <div class="fui-cell-remark noremark"><?php  echo $ordercredit;?><?php  echo $_W['shopset']['trade']['credittext'];?> + &yen;<?php  echo $ordermoney;?></div>
            </div>
            <?php  if($goods['goodstype']==0 && $goods['isverify']==0) { ?>
            <div class="fui-cell">
            ...
            <div class="fui-cell">
                ...
                <div class="fui-cell-remark noremark">
                    <span class='text-danger2'>
                        <?php  echo $ordercredit;?><?php  echo $_W['shopset']['trade']['credittext'];?><?php  if(($ordermoney + $goods['dispatch']) >0) { ?> + &yen; <?php  echo number_format($ordermoney + $goods['dispatch'],2)?><?php  } ?>
                    </span>
                </div>
            </div>
        </div>
