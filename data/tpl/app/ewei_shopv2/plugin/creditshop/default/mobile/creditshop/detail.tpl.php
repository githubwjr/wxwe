                ...
                <div class="fui-cell-text flex">
                    <span class="price" style="text-align: left;">
                        <?php  if($goods['hasoption']>0) { ?>
                            <span class="big" style="font-weight: bold;font-size: 0.8rem"><?php  if($goods['mincredit'] == $goods['maxcredit']) { ?><?php  echo $goods['mincredit'];?><?php  } else { ?><?php  echo $goods['mincredit'];?>~<?php  echo $goods['maxcredit'];?><?php  } ?></span>
                            <span style="font-weight: bold;font-size: 0.6rem"><?php  echo $_W['shopset']['trade']['credittext'];?></span>
                            <?php  if($goods['money'] > 0) { ?>
                                + <span style="font-size: 0.8rem;font-weight: bold;padding-right: 0.1rem;"><span style="font-size: 0.7rem">&yen;</span><?php  if($goods['minmoney'] == $goods['maxmoney']) { ?><?php  echo $goods['minmoney'];?><?php  } else { ?><?php  echo $goods['minmoney'];?>`<?php  echo $goods['maxmoney'];?><?php  } ?></span>
                            <?php  } ?>
                        <?php  } else { ?>
                            <span class="big" style="font-weight: bold;font-size: 0.8rem"><?php  echo $goods['credit'];?></span>
                            <span style="font-weight: bold;font-size: 0.6rem"><?php  echo $_W['shopset']['trade']['credittext'];?></span>
                            <?php  if($goods['money'] > 0) { ?>
                                + <span style="font-size: 0.8rem;font-weight: bold;padding-right: 0.1rem;"><span style="font-size: 0.7rem">&yen;</span><?php  echo $goods['money'];?></span>
                            <?php  } ?>
                        <?php  } ?>
