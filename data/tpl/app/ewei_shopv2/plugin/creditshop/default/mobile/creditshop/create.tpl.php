...
<style type="text/css">
    ...
    <?php  } else { ?>
        ...
        .fui-actionsheet a.balance{display: none;}
        <?php  } ?>
        <?php  if($pay['app_wechat'] == 0) { ?>
        .fui-actionsheet a.wechat{display: none;}
        <?php  } ?>
        <?php  if($pay['app_alipay'] == 0) { ?>
        .fui-actionsheet a.alipay{display: none;}
        <?php  } ?>
    <?php  } ?>
    .text-danger2 {
...
<div class='fui-page order-detail-page'>
                ...
                <div class="fui-list goods-list">
                    ...
                    <div class='fui-list-angle'>
                        <span class='marketprice'>
				            ...
				            <?php  if($goods['type'] == 1) { ?><br/>   x 1<?php  } ?>
                        </span>
                    </div>
                </div>
            </a>
        ...
        <div class='fui-cell-group price-cell-group'>
            <div class="fui-cell">
                ...
                <div class="fui-cell-remark noremark">
                    <span id="showcredit"><?php  echo $goods['credit'];?></span><?php  echo $_W['shopset']['trade']['credittext'];?>
                    + &yen;<span id="showmoney"><?php  echo $goods['money'];?></span>
                </div>
            </div>
    ...
    <div class='fui-footer fui-navbar order-create-checkout'>
        <p class="nav-item" style="width:10%;text-align: left;padding:0.3rem;font-size:0.7rem;">
            ...
            <span class="text-danger2" style="background: none;">
                <span id="realcredit"><?php  echo $goods['credit'];?></span><?php  echo $_W['shopset']['trade']['credittext'];?>
    ...
    <script language='javascript'>
        require(['../addons/ewei_shopv2/plugin/creditshop/static/js/create.js'], function (modal) {
            modal.init({goods: <?php  echo json_encode($goods)?>,optionid:<?php  echo $optionid;?>,chance:<?php  echo $chance;?>});
        });
    </script>
</div>
