<?php defined('IN_IA') or exit('Access Denied');?>            <div class="form-group">
                ...
                <div class="col-sm-4 col-xs-6">
                    <?php echo tpl_form_field_daterange('coupontime', array('starttime'=>date('Y-m-d H:i', !empty($item['coupontime']['start'])?$item['coupontime']['start']:time()),'endtime'=>date('Y-m-d H:i', !empty($item['coupontime']['end'])?$item['coupontime']['end']:time())),true);?>
                </div>
            </div>
