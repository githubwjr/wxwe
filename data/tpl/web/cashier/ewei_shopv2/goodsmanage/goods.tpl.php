                ...
                <div class="panel panel-default  panel-class col-sm-6">
                    ...
                    <div class="panel-body" style="height:500px;overflow:auto">
                        <table class="table right">
                            <?php  if(!empty($item['goods_ids'])) { ?>
                            <?php  if(is_array($goods)) { foreach($goods as $key => $val) { ?>
                            <tr data-id="<?php  echo $val['id'];?>" data-title="<?php  echo $val['title'];?>" data-thumb="<?php  echo $val['thumb'];?>">
                                <td class="col-sm-2">
                                    <img src="<?php  echo $val['thumb'];?>" style="width:50px;height:50px;">
                                </td>
