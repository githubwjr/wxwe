		...
		<div class="panel panel-cut">
			...
			<div class="panel-body">
				<div class="wxapp-manage">
					<a href="<?php  echo url('wxapp/post/design_method', array('uniacid' => $uniacid))?>" class="color-default"><i class="wi wi-registersite"></i>新建版本</a>
				</div>
					...
					<li class="wxapp-cut-item">
						<div class="wxapp-item-iphone">
							...
							<div class="cover-dark">
								<a href="<?php  echo url('wxapp/version/manage', array('version_id' => $list['id']))?>" class="manage-fa"><i class="fa fa-angle-right"></i></a>
								<a href="<?php  echo url('wxapp/version/manage', array('version_id' => $list['id']))?>" class="manage">管理</a>
