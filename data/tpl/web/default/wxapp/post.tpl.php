							...
							<div id="select" ng-show="createStep == 1">
								<div class="form-defalut we7-form">
									...
									<div class="form-group">
										...
										<div class="form-controls col-sm-10">
											<input type="text" name="account" ng-model="wxappinfo.account" class="form-control wxapp-name" placeholder="小程序账号">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="form-controls col-sm-10">
											<input type="text" name="version" ng-model="wxappinfo.version" class="form-control wxapp-name" placeholder="版本号，只能是字母、数字，例如: v1.0.1">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="form-controls col-sm-10">
											<div we7-select-more we7-modules="wxappinfo.select.modules" we7-selecte-single="<?php  echo $design_method == WXAPP_MODULE?>"></div>
										</div>
									</div>
								</div>
							</div>
								...
								<div ng-if="designMethod == 2">
									...
									<div class="creat-select-tem">
										...
										<div class="select-tem-list">
											<input type="hidden" name="template" ng-model="wxappinfo.select.template" />
											<ul>
												<li class="select-tem-item" ng-class="{'active' : wxappinfo.select.template == '1'}" ng-click="selectTpl(1)">
							...
							<div id="finish" ng-show="createStep == 4">
								<div class="form we7-form wxapp-finish">
									...
									<div class="form-group">
										...
										<div class="form-controls col-sm-10">
											<ul class="app-list">
												<li class="select" ng-repeat="module in wxappinfo.select.modules">
													<div class="app-info">
									...
									<div class="form-group" ng-if="designMethod == 2">
										...
										<div class="form-controls col-sm-10">
											<p class="form-control-static" ng-bind="wxappinfo.select.template"></p>
										</div>
									</div>
									<div class="form-group" ng-if="designMethod == 2">
				...
				<nav class="navbar navbar-wxapp-bottom navbar-fixed-bottom" role="navigation">
					<div class="container">
						<div class="pager">
							...
							<button type="submit" name="submit" value="yes" class="btn btn-danger" ng-show="createStep == 4">生成版本打包下载</button>
