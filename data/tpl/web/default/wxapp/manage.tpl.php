		...
		<tr ng-if="version_exist" ng-repeat="version in wxapp_version_lists">
			...
			<td class="text-right">
				<div class="link-group">
					<a href="./index.php?c=wxapp&a=version&do=manage&multiid={{version.multiid}}&uniacid={{version.uniacid}}&version_id={{version.id}}">进入</a>
					<a href="./index.php?c=wxapp&a=manage&do=getpackage&uniacid={{version.uniacid}}&versionid={{version.id}}">下载</a>
					<a href="javascript:;" ng-click="showEditVersionInfoModal(version)">修改</a>
