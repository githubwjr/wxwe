						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<select class="we7-select" ng-model="new_type" ng-init="new_type = 'reply'">
										<option value="reply" >图文编辑</option>
										<option value="link">跳转链接</option>
									</select>
									<!-- <span class="help-block">{{new_type}}</span> -->
								</div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="createNew(new_type)">确定</button>
