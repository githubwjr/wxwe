...
<ul class="we7-page-tab">
	...
	<li><a href="<?php  echo url('user/display/check_display');?>">审核用户</a></li>
	<li><a href="<?php  echo url('user/display/recycle_display');?>">用户回收站</a></li>
	<li class="active"><a href="<?php  echo url('user/fields/display');?>">用户属性设置</a></li>
