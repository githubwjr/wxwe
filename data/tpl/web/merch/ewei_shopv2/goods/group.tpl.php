        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-responsive">
                    <thead>
            <tr>
                <?php if(mcv('goods.group.delete|goods.group.edit')) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(mcv('goods.group.view|goods.group.edit')) { ?>
                        <a class="btn btn-default btn-sm btn-operation btn-op" href="<?php  echo webUrl('goods/group/edit', array('id'=>$item['id']))?>">
                             <span data-toggle="tooltip" data-placement="top" title="" data-original-title=" <?php if(mcv('goods.group.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
