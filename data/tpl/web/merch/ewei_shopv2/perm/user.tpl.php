                ...
                <div class="page-toolbar m-b-sm m-t-sm">
                            <div class="col-sm-4">
                                <span class="pull-left">
                                   <?php  if('perm.user.add' && $_W['accounttotal']>$total) { ?>
            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(mcv('perm.user.view|perm.user.edit')) { ?><a class='btn btn-default btn-sm btn-op btn-operation' href="<?php  echo merchUrl('perm/user/edit', array('id' => $row['id']))?>">
