            ...
            <table class="table table-hover  table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <?php if(mcv('perm.role.edit|perm.role.view')) { ?><a class='btn btn-default btn-sm btn-op btn-operation' href="<?php  echo merchUrl('perm/role/edit', array('id' => $row['id']))?>">
                                <span data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php if(mcv('perm.role.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>">
                                    <i class='icow icow-bianji2'></i>
                               </span>
                            </a>
                            <?php  } ?>
                          <?php if(mcv('perm.role.delete')) { ?><a class='btn btn-default  btn-sm btn-op btn-operation' data-toggle="ajaxRemove"  href="<?php  echo merchUrl('perm/role/delete', array('id' => $row['id']))?>" data-confirm="确认删除此角色吗？">
