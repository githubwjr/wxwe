...
<div class="page-header">魔方推荐</div>
					...
					<tr class="cube-item">
						...
						<td>
							<div class="input-group img-item">
								...
								<input type="text" class="form-control" name="cube_img[]" value="<?php  echo $cube['img'];?>" <?php if(mcv('shop.cube.edit')) { ?> <?php  } else { ?> readonly="readonly"<?php  } ?> />
								<?php if(mcv('shop.cube.edit')) { ?>
						...
						<td>
							<div class="input-group form-group" style="margin: 0;">
								<?php if(mcv('shop.cube.edit')) { ?>
									<input type="text" value="<?php  echo $cube['url'];?>" class="form-control valid" name="cube_url[]" placeholder="" <?php if(mcv('shop.cube.edit')) { ?>id="cubelink_<?php  echo $i+10000?>"<?php  } else { ?> readonly="readonly"<?php  } ?>>
									<span class="input-group-btn">
										<span data-input="#cubelink_<?php  echo $i+10000?>" data-toggle="selectUrlMerch" class="btn btn-default">选择链接</span>
									</span>
								<?php  } else { ?>
						...
						<td>
							<?php if(mcv('shop.shop.cube.edit')) { ?>
