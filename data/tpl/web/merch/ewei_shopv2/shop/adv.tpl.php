        ...
        <table class="table table-responsive table-hover" >
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <?php if(mcv('shop.adv.view|shop.adv.edit')) { ?>
                    <a href="<?php  echo webUrl('shop/adv/edit', array('id' => $row['id']))?>" class="btn btn-op btn-operation" >
                                        <span data-toggle="tooltip" data-placement="top" data-original-title="<?php if(mcv('shop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
