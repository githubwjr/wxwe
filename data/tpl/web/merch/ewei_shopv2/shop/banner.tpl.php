                    ...
                    <?php  if(is_array($list)) { foreach($list as $row) { ?>
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php if(mcv('shop.banner.view|shop.banner.edit')) { ?>
                                    <a href="<?php  echo webUrl('shop/banner/edit', array('id' => $row['id']))?>" class="btn btn-op btn-operation">
                                        <span data-toggle="tooltip" data-placement="top" data-original-title="<?php if(mcv('shop.banner.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
