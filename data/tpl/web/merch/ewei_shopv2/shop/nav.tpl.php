                    ...
                    <?php  if(is_array($list)) { foreach($list as $row) { ?>
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php if(mcv('shop.nav.view|shop.nav.edit')) { ?>
                                    <a href="<?php  echo webUrl('shop/nav/edit', array('id' => $row['id']))?>" class="btn btn-op btn-operation">
                                        <span data-toggle="tooltip" data-placement="top" data-original-title="<?php if(mcv('shop.nav.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
