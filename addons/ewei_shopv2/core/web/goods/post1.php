...
if ($_W['ispost']) {
	...
	$data = array('uniacid' => intval($_W['uniacid']),
        ...
        'presellovertime' => (0 < intval($_GPC['presellovertime']) ? intval($_GPC['presellovertime']) : 0),
        'presellprice' => floatval($_GPC['presellprice']),
        'presellstart' => intval($_GPC['presellstart']),
        'presellend' => intval($_GPC['presellend']),
        'preselltimestart' => (0 < intval($_GPC['presellstart']) ? strtotime($_GPC['preselltimestart']) : 0),
        'preselltimeend' => (0 < intval($_GPC['presellend']) ? strtotime($_GPC['preselltimeend']) : 0),
        ...
        'virtual' => ($goodstype == 3 ? intval($_GPC['virtual']) : 0), 'ednum' => intval($_GPC['ednum']),
