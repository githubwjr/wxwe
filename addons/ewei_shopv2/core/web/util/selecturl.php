	...
	public function main() 
	{
       ...
       if (p("friendcoupon")) {
		...
		if( $platform ) 
		{
            ...
            $allUrls[0]["list"][] = array( "name" => "拼团首页", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/groups/index/index" );
			$allUrls[0]["list"][] = array( "name" => "文章营销", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/changce/article/list" );
          $allUrls[0]["list"][] = array( "name" => "团队分红", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/dividend/pages/index/index" );
