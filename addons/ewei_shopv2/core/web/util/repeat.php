...
class Repeat_EweiShopV2Page extends WebPage
{
	...
	public function init()
	{
		...
		pdo_run('CREATE TABLE ' . tablename('ewei_shop_member_tmp') . ' (`uniacid` int(11) DEFAULT \'0\',`openid` varchar(50) CHARACTER SET utf8mb4 DEFAULT \'\') ENGINE=MyISAM DEFAULT CHARSET=utf8;');
