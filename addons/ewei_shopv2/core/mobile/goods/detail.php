...
class Detail_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		$commission_data['isagent'] = $isagents['status'];
...
//					'price'    => array('text' => $price, 'left' => 270, 'top' => 930, 'size' => 30, 'color' => '#f20'),
	...
	public function get_comments() 
	{
		...
		$data = m("member")->getMember($_W['openid']);

//		var_dump($isagents);die;
		//$isagents['isagent'] = 0;
		show_json(1, array( "count" => $count, "percent" => $percent, "list" => $list,'isagent_status'=>$data['status']));
	}
